...
int main() {  
	...
	outfile<<"EditorFont="<< a << "\\InjectResource\\Fonts\\msyhbd.ttc" <<std::endl;
	outfile<<"EditorFontSize=17"<< std::endl;
	outfile<<"EditorStyleIndex=0"<< std::endl;
	outfile<<"Font="<< a << "\\InjectResource\\Fonts\\msyhbd.ttc" << std::endl;
	...
	outfile<<"LatinFont="<< a << "\\InjectResource\\Fonts\\msyhbd.ttc" << std::endl;

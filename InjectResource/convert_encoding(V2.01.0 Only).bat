...
::You don't need to modify the following code until line 60
...
::If you have modified the file you want to convert the encoding above, you will need to modify the code here

set "source_folder=.\AfterConvert"  
set "destination_folder=..\ReShade.ini"  
move /y "%source_folder%\ReShade.ini" "%destination_folder%" >nul 2>&1 
